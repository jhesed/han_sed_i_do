    	...
    	<div class="top-right">        	
            <div class="phone">
            	<?php if(get_theme_mod('phone-txt') != '') { ?>              	
                    <i class="fa fa-envelope-o"></i><a href="<?php echo esc_attr(esc_html('mailto:','forever-lite').get_theme_mod('email-txt')); ?>"><?php echo esc_attr(get_theme_mod('email-txt')); ?></a>
				<?php }?>            	
            </div>
            <div class="clear"></div>
...
<div class="header">
	<div class="header-inner">
      <div class="logo">
       <?php forever_lite_the_custom_logo(); ?>
    ...
    <div class="header_right">        		              
              <div class="toggle">
                ...
                <?php esc_html_e('Menu','forever-lite'); ?>                
            </a>
            </div><!-- toggle -->    
            <div class="sitenav">                   
