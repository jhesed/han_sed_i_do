...
<section id="proposal">
  <div class="wow zoomInDown">
       <h1 class="countdown-timer"><b>The Proposal</b></h1>
       <div id="proposal-gallery"></div>
        <div class="clear"></div> 
  </div>
</section>
      ...
      <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item">
            <div class="caption">
              ...
              <div class="image">
                <video width="600" height="400" src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/videos/proposal/sed-proposal-min.mp4"></video>
                <div class="title">
                  <h3>The Proposal</h3>
                </div>
              </div>
...
<section id="waze">
  <div class="container wow lightSpeedIn">
        <h3>Directions</h3>
        <iframe src="https://embed.waze.com/iframe?zoom=16&lat=14.612021&lon=121.125493&ct=livemap" width="60%" height="600" allowfullscreen></iframe>
