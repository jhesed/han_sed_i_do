...
<div class="container">
    ...
    <?php
        $theme_lay = get_theme_mod( 'vw_wedding_theme_options','Right Sidebar');
        if($theme_lay == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div id="our-services" class="services col-md-8 col-sm-8">
                    ...
                    printf( esc_html__( 'Results For: %s','vw-wedding'), esc_html( get_search_query() ) ); ?></h1> 
                    <?php if ( have_posts() ) :
                        /* Start the Loop */
                    ...
                    <div class="navigation">
                        <?php
                            ...
                            the_posts_pagination( array(
                                'prev_text'          => __( 'Previous page', 'vw-wedding' ),
                                'next_text'          => __( 'Next page', 'vw-wedding' ),
                                'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-wedding' ) . ' </span>',
                            ) );
                        ?>
